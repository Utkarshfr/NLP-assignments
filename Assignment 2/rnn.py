...
def plot_loss_over_epochs(training_losses, validation_losses):
...
if __name__ == "__main__":
    ...
    model = RNN(50, h=args.hidden_dim)   # Fill in parameters
    ...
    while not stopping_condition :
        ...
        validation_losses.append(1 - (correct/total))
    ...
    plot_loss_over_epochs(training_losses, validation_losses)
